...
- 🎯 Entry points to execute your program using `python -m <asyncio_inspector>` or `$ asyncio_inspector` with basic CLI argument parsing.
...
```py
from asyncio_inspector import BaseClass
from asyncio_inspector import base_function
